...
clover_xml=$omc_output_directory/clover/clover.xml

$OMCJ/scripts/compute_omc.sh $clover_xml $omc_output_directory $OMC_EXPERIMENTS/specs/$PROJECT_NAME/prefix.txt
