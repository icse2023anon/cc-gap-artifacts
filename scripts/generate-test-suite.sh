...
JAVA_HOME=/home/stg/jdk1.8.0_311
PATH=$JAVA_HOME/bin:$PATH

R_JAR=$OMCJ/lib/testsuite-gen.jar
...
PROJECT_HOME=$OMC_EXPERIMENTS/subjects/$PROJECT_NAME
SLICE_DIR=$OMC_EXPERIMENTS/slices/$PROJECT_NAME
CLOVER=$OMC_EXPERIMENTS/omc_results/$PROJECT_NAME/clover/clover.xml
PREFIX=$OMC_EXPERIMENTS/specs/$PROJECT_NAME/prefix.txt
...
#clover=fse-joda-time/omc_results/fse-joda-time/clover/clover.xml
