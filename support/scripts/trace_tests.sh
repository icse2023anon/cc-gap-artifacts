...
# $OMC_TRACES is the output trace directory
...
TRACER_JAR=$OMCJ/lib/tracer.jar
...
#export CLASSPATH=$PROJECT_HOME/target/test-classes:$PROJECT_HOME/target/classes:$PROJECT_HOME/target/dependency:$MAVEN_REPO/org/joda/joda-convert/1.9.2/joda-convert-1.9.2.jar:$MAVEN_REPO/junit/junit/4.11/junit-4.11.jar:$MAVEN_REPO/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar:$MAVEN_REPO/commons-io/commons-io/2.6/commons-io-2.6.jar:$MAVEN_REPO/com/fasterxml/jackson/core/jackson-databind/2.9.10/jackson-databind-2.9.10.jar:$MAVEN_REPO/com/fasterxml/jackson/core/jackson-core/2.9.10/jackson-core-2.9.10.jar:$MAVEN_REPO/xmlpull/xmlpull/1.1.3.1/xmlpull-1.1.3.1.jar:$PROJECT_HOME/target/OSGi:$PROJECT_HOME/target/OSGi/MANIFEST.MF
#export CLASSPATH=$PROJECT_HOME/target/test-classes:$PROJECT_HOME/target/classes:$MAVEN_REPO/org/joda/joda-convert/1.9.2/joda-convert-1.9.2.jar:$MAVEN_REPO/junit/junit/4.11/junit-4.11.jar:$MAVEN_REPO/org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar:$MAVEN_REPO/commons-io/commons-io/2.6/commons-io-2.6.jar:$MAVEN_REPO/com/fasterxml/jackson/core/jackson-databind/2.9.10/jackson-databind-2.9.10.jar:$MAVEN_REPO/com/fasterxml/jackson/core/jackson-core/2.9.10/jackson-core-2.9.10.jar:$PROJECT_HOME/target/OSGi
...
echo "omcj: Debug CLASSPATH: $CLASSPATH"
...
do
	...
	trace_dir=$OMC_TRACES/${package_name}_traces
	if [ ! -d $trace_dir ]; then
		mkdir $trace_dir
	fi
	...
	echo "Attempting to detect main() in ${PROJECT_TEST_DIR}"
...
#		echo "Turn off trace, simple debugging with: java org.junit.runner.JUnitCore $fq_test_class"
...
#    $PROJECT_HOME/lib/compile/* for barbecue and maybe other ant-based projects?
#		timeout $TIMEOUT_SEC java -cp "$CLASSPATH:$PROJECT_HOME/target/dependency/*:$PROJECT_HOME/lib/compile/*" -Xmx7g -javaagent:$TRACER_JAR=tracefile:$trace_dir/$test_class_name.trace org.junit.runner.JUnitCore $fq_test_class
